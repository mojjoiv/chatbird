...
class _ChatScreenState extends State<ChatScreen> {
  Color sentMessageColor = const Color(0xFFFF0075);
...
class _ChatMessages extends StatelessWidget {
  ...
  final Chat chat;
  final Color sentMessageColor = const Color(0xFFFF0075);
  final Color receivedMessageColor = Colors.black;
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.only(
                  topLeft:
                      Radius.circular(10.0), // Maintain rounded top left corner
                  topRight: Radius.zero, // Sharp top right corner
                  bottomRight: Radius.circular(
                      10.0), // Maintain rounded bottom right corner
                  bottomLeft: Radius.circular(
                      10.0), // Maintain rounded bottom left corner
                ),
              ),
              child: Text(
                message.text,
